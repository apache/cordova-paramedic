...
class ParamedicConfig {
    static DEFAULT_START_PORT = 7008;
    static DEFAULT_END_PORT = 7208;
    ...
    /**
     * Retuns possible ports to use for the paramedic server.
     * @returns {Object}
     */
    getPorts () {
        const start = this._config.startPort || ParamedicConfig.DEFAULT_START_PORT;
        const end = this._config.endPort || ParamedicConfig.DEFAULT_END_PORT;
